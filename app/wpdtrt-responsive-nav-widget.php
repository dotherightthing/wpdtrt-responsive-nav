...
if ( !class_exists( 'Wpdtrt_Responsive_Nav_Widget' ) ) {
   ...
   */
  class Wpdtrt_Responsive_Nav_Widget extends WP_Widget {

    function __construct() {
      // Instantiate the parent object
      parent::__construct( false, 'DTRT Responsive Nav Widget' );
    }
     ...
     * This function's variables will be available to this template.
     */
      require(WPDTRT_RESPONSIVE_NAV_PATH . 'templates/wpdtrt-responsive-nav-widget.php');
    }
  }

}

if ( !function_exists( 'wpdtrt_responsive_nav_register_widgets' ) ) {
  ...
  function wpdtrt_responsive_nav_register_widgets() {
    register_widget( 'Wpdtrt_Responsive_Nav_Widget' );
  }

  add_action( 'widgets_init', 'wpdtrt_responsive_nav_register_widgets' );
