...
<div class="wrap">
  ...
  <h1><?php esc_attr_e( 'DTRT Responsive Nav', 'wp_admin_style' ); ?>: Placeholder blocks</h1>
    ...
    <div id="post-body" class="metabox-holder columns-2">
      ...
      <div id="post-body-content">
        ...
        <div class="meta-box-sortables ui-sortable">
           ...
           * then $wpdtrt_responsive_nav_datatype will be set to the default of ""
           * The user must make a selection so that we know which page to query,
           * so we show the selection box first.
           */
          if ( !isset( $wpdtrt_responsive_nav_datatype ) || ( $wpdtrt_responsive_nav_datatype === '') ) :
          ?>
            ...
            <div class="inside">
              ...
              <form name="wpdtrt_responsive_nav_data_form" method="post" action="">
                ...
                <table class="form-table">
                  <tr>
                    <th>
                      <label for="wpdtrt_responsive_nav_datatype">Please select a block type:</label>
                    </th>
                    <td>
                      <select name="wpdtrt_responsive_nav_datatype" id="wpdtrt_responsive_nav_datatype">
           ...
           * then $wpdtrt_responsive_nav_data will contain the body of the resulting JSON.
           */
          ...
          <div class="postbox">
            ...
            <div class="inside">
              ...
              <p>This data set contains <?php echo count( $wpdtrt_responsive_nav_data ); ?> blocks.</p>

              <p>The first 6 are displayed below:</p>

              <div class="wpdtrt-responsive-nav-blocks">
                <ul>
                ...
                <?php
                  ...
                  foreach( $wpdtrt_responsive_nav_data as $key => $val ) {
                    echo "<li>" . wpdtrt_responsive_nav_html_image( $key ) . "</li>\r\n";
              ...
              <?php
                echo wpdtrt_responsive_nav_html_date();
              ?>
          ...
          <div class="postbox">
            ...
            <div class="inside">
              ...
              <div class="wpdtrt-responsive-nav-data"><pre><code><?php echo "{\r\n";

                  $count = 0;
                  $max_length = 6;

                  foreach( $wpdtrt_responsive_nav_data as $key => $val ) {
                    var_dump( $wpdtrt_responsive_nav_data[$key] );
            ...
            <div class="inside">
              ...
              <form name="wpdtrt_responsive_nav_data_form" method="post" action="">
                ...
                <p>
                  ...
                  <select name="wpdtrt_responsive_nav_datatype" id="wpdtrt_responsive_nav_datatype">
                    <option value="">None</option>
                    <option value="photos" <?php selected( $wpdtrt_responsive_nav_datatype, "photos" ); ?>>Coloured blocks</option>
                    <option value="users" <?php selected( $wpdtrt_responsive_nav_datatype, "users" ); ?>>Maps</option>
                  </select>
                </p>
                <p>
