 ...
 *    WP Admin > Appearance > Widgets > DTRT Responsive Nav
 *
...
<p>
  ...
  <span id="<?php echo $this->get_field_name('number'); ?>-tip" class="wpdtrt-responsive-nav-tip">Minimum: 1 | Maximum: <?php echo count($wpdtrt_responsive_nav_data); ?></span>
</p>
